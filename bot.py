...
if hasattr(weather_mcp, "streamable_http_app"):
...
async def main():
    ...
    from services.telegram_hub_bot.app import start_telegram_bot
    ...
    await asyncio.gather(server_task, keep_alive_task, telegram_task)
