...
from .admin import (
    auth, connections, danger_zone, logs, reports, rooms, settings, stats, users, views, recordings, explorer
)
...
api_router.include_router(explorer.router, tags=["Explorer"]) # <-- ДОБАВЛЕНО
