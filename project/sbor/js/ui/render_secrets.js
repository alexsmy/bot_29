...
function buildSummaryHtml() {
    ...
    return `
        ...
        <div class="info-box warning" style="margin-bottom: 1.25rem;">
            Обнаруживаются только высоковероятные секреты. Подозрительные строки вроде <code>tokenKey: 'pvz_auth_token'</code> не считаются секретом, если в значении нет реальной ключевой структуры.
